...
import { startCreateProduct, startUpdateProduct } from '../../redux/productsSlice/thunk';
...
export const ProductsModal = () => {
    ...
    return (
        <Modal size='lg' show={modal === 'product' ? true : false} onHide={handleClose} >
            <Form onSubmit={handleSubmit(Object.keys(dataModal).length ? updateProduct : createProduct)}>
