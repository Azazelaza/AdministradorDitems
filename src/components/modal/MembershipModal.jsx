...
import { membership } from "../../validates/validations";
...
export const MembershipModal = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm({ resolver: yupResolver(membership) });
      ...
      >
        ...
        <Modal.Body className={styles.modalGeneral}>
          <Row>
            ...
            <Col sm={12}>
              <Form.Group controlId="isActive" className="form-checkbox d-flex">
                <Form.Label className="pe-2">Activo</Form.Label>
